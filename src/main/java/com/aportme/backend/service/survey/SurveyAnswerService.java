...
import com.aportme.backend.entity.dto.SurveyAnswerDTO;
...
public class SurveyAnswerService {
    ...
    public void createAnswers(Survey survey, Long foundationId, List<SurveyAnswerDTO> dto) {
        ...
        List<SurveyAnswer> answers = dto.stream()
