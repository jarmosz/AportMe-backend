...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST,"/api/users/sendResetPasswordLink").permitAll()
                .antMatchers(HttpMethod.GET,"/api/users/resetPassword/validateToken").permitAll()
                .antMatchers(HttpMethod.POST,"/api/users/resetPassword").permitAll()
                .antMatchers(HttpMethod.POST,"/api/users/resetPassword/changePassword").permitAll()
